    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div>
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-zinc-100">Nodes</h1>

          <p className="mt-1 text-sm text-zinc-400">

            Edge nodes and their health. {nodes.length} registered.
    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-4">
      ...
      <p
        ...
        className={cn(
          ...
          accent === "emerald" ? "text-emerald-500" : "text-zinc-100",
...
function NodeRow({ node }: { node: Node }) {
  ...
  return (
    ...
    <tr className="transition-colors duration-200 hover:bg-[#1c1c20]">
      ...
      <td className="px-4 py-3 text-zinc-400">{node.region}</td>
      ...
      <td className="hidden px-4 py-3 font-mono text-zinc-400 sm:table-cell">
...
function RegisterNodeForm({
  ...
  const fieldClass =
    ...
    "h-10 rounded-lg border border-zinc-800 bg-zinc-950/50 px-3 text-sm text-zinc-100 outline-none transition-all duration-200 focus:border-zinc-700";
  ...
  return (
    ...
    <div className="flex flex-col gap-4 rounded-xl border border-zinc-800 bg-zinc-900 p-5">
      ...
      <h3 className="text-sm font-medium text-zinc-100">Register a new node</h3>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <input
          ...
          placeholder="node name (e.g. au-edge-01)"
  ...
  return (
    ...
    <label className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className="h-10 rounded-lg border border-zinc-800 bg-zinc-950/50 px-3 font-mono text-sm text-zinc-100 outline-none transition-all duration-200 focus:border-zinc-700"
